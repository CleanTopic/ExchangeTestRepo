package ru.cleantopic.feature.template

import ru.cleantopic.feature.template.Utils.toSnakeCase
...
class GenerateRecyclerAdapter(
    ...
    private var packageName = "ru.cleantopic"
    private var directoryPath = "feature/src/main/java/ru/cleantopic/feature/"
